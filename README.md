...
## Team 8075 Notes
Before executing a movement, make sure that rviz is paying attention to what it should be.
1. Add → By display type → InteractiveMarkers.
    a. Set Update Topic to the thing it should be listening to